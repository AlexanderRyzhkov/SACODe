...
class FiltersView(QMainWindow):
    def __init__(self, previous_view, p, is_file_mode):
        def configure_main_widget():
            def configure_main_layout():
                ...
                main_layout.addLayout(self.configure_filters_layout(filters_list_layout))
                main_layout.addLayout(self.configure_menu_layout(filters_list_layout, previous_view))
    ...
    def configure_change_filters_layout(self, filters_matrices_list, filters_list_layout):
    ...
    def configure_filters_layout(self, filters_list_layout):
        description = QLabel()
